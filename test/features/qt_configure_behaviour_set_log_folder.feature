Feature: TestObject::set_log_folder (Rename this to be more descriptive)
  ...
  Scenario: Testing set_log_folder method with required argument(s) (Rename this to be more descriptive)
    Given I launch application [APPLICATION_NAME] as @app
    When I execute "@app.[SOME_OBJECT].set_log_folder(folder)"
