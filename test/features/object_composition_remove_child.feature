...
Feature: MobyBehaviour::ObjectComposition#remove_child
  ...
  Scenario: Testing remove_child method with required argument(s) (Rename this to be more descriptive)
    Given I launch application [APPLICATION_NAME] as @app
    When I execute "@app.[SOME_OBJECT].remove_child(target_child_object)"
